...
void Game::LoadData()
{
    musicFast=this->GetSound("Assets/Sounds/MusicFast.ogg");
    raceStart=this->GetSound("Assets/Sounds/RaceStart.wav");
    music=this->GetSound("Assets/Sounds/Music.ogg");
    finalLap=this->GetSound("Assets/Sounds/FinalLap.wav");
    won = this->GetSound("Assets/Sounds/Won.wav");
    lost = this->GetSound("Assets/Sounds/Lost.wav");
    hm = new HeightMap();
    Actor* track = new Actor(this);
    track->SetRotation(Math::Pi);
    MeshComponent* trackMC = new MeshComponent(track);
    trackMC->SetMesh(GetRenderer()->GetMesh("Assets/Track.gpmesh"));
